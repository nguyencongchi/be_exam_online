        ...
        1: [function (e, n, t) {
            ...
            (function (t) {
                ...
                function r(e, n) {
                    ...
                    function r(e) {
                        var n = e ? "remove" : "add";
                        o(S, n, "mousedown", N), o(S, n, "mouseup", L)
                    }
                    ...
                    function m(e) {
                        var n = e ? "remove" : "add";
                        w[n](S, "selectstart", O), w[n](S, "click", O)
                    }
                    ...
                    function L(e) {
                        if (I(), le.dragging) {
                            ...
                            i && (ie && fe.copySortSource || !ie || i !== Q) ? R(n, i) : fe.removeOnSpill ? A() : M()
                        }
                    }
                    ...
                    function M(e) {
                        if (le.dragging) {
                            var n = arguments.length > 0 ? e : fe.revertOnSpill, t = ie || W, r = v(t);
                            r === Q && ie && r.removeChild(ie);
                            var o = k(r);
                            o === !1 && !ie && n && Q.insertBefore(t, re), o || n ? le.emit("cancel", t, Q, Q) : le.emit("drop", t, r, Q, oe), j()
                        }
                    }
                    ...
                    function U(e) {
                        ...
                        if (J) {
                            ...
                            (null === m || m !== f && m !== g(f) && m !== oe) && (oe = m, d.insertBefore(f, m), le.emit("shadow", f, d, Q))
                        }
                    }
                ...
                function c(e, n) {
                    return "undefined" != typeof t[n] ? t[n] : S.clientHeight ? S[e] : C[e]
                }
                ...
                var b = e("contra/emitter"), w = e("crossvent"), E = e("./classes"), x = document,
                    S = x.documentElement, C = x.body;
                n.exports = r
